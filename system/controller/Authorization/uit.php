...
/**
 * This is the UIT implementation of the authorization class
 */
class Authorization_uit extends Authorization
{
    ...
    {
        return (   $this->is_authenticated() 
                && $this->bofh->hasSpreads('exchange_mailbox'));
    }
