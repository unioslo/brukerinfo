...
if(isset($primary['quota_used'])) {
    $prilist->addData(txt('email_info_quota'), txt('email_info_quota_info', $primary['quota_used'], 
        $primary['quota_hard'], $primary['quota_soft']));
...
if(isset($primary['spam_level'])) {
    $prilist->addData(txt('email_info_spam_level'), $primary['spam_level_desc'] . ' ('.ucfirst($primary['spam_level']).')');
    unset($primary['spam_level']);
    unset($primary['spam_level_desc']);
}
// spam action
if(isset($primary['spam_action'])) {
    $prilist->addData(txt('email_info_spam_action'), $primary['spam_action_desc'] . ' ('.ucfirst($primary['spam_action']).')');
